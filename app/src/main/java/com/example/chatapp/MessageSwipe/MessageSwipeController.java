package com.example.chatapp.MessageSwipe;
...
//        shareRound = context.getDrawable(R.drawable.ic_round_shape);
    ...
    private void drawReplyButton(Canvas canvas) {
        ...
        shareRound.setColorFilter(new PorterDuffColorFilter(ContextCompat.getColor(context, R.color.green), PorterDuff.Mode.MULTIPLY));
